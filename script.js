...
document.querySelectorAll('.service-card, .about-text, .about-image, .result-item, .faq-item').forEach(el => {
    el.style.opacity = '0';
...
if (consultationForm) {
    consultationForm.addEventListener('submit', (e) => {
        ...
        const procedure = consultationForm.querySelector('select').value;
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Set initial state for result items
    resultItems.forEach(item => {
